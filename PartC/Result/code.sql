...
CREATE INDEX index1 ON AIRCRAFTDIMENSION (model,manufacturer) PCTFREE 33; 
ALTER TABLE PEOPLEDIMENSION SHRINK SPACE;
CREATE  INDEX index2 ON PEOPLEDIMENSION (role) PCTFREE 33; 
ALTER TABLE TEMPORALDIMENSION SHRINK SPACE;
ALTER TABLE MONTHS SHRINK SPACE;
ALTER TABLE AIRCRAFTUTILIZATION SHRINK SPACE;
CREATE BITMAP INDEX index4 ON AIRCRAFTUTILIZATION(AIRCRAFTID,cancellations) PCTFREE 0;
ALTER TABLE LOGBOOKREPORTING SHRINK SPACE;
CREATE BITMAP INDEX index3 ON LOGBOOKREPORTING(AIRCRAFTID) PCTFREE 0;
